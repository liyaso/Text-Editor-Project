"""
This file allows the syntax highlighter, autocompletion, and line numbers to show on the GUI
"""
...
class Editor(QsciScintilla):
    def __init__(self, parent=None, path: Path = None, is_python_file=True):
        ...
        self.setUtf8(True)                                        # encoding
        # set the font and the font size for the text editor
        self.window_font = QFont("Arial")
        self.window_font.setPointSize(12)
        self.setFont(self.window_font)                     

        self.setBraceMatching(QsciScintilla.SloppyBraceMatch)     # brace matching
        ...
        self.setAutoCompletionThreshold(1)                        # autocomplete should show up after typing 1 charachter
        ...
        if self.is_python_file:       
            ...
            self.pylexer = PyCustomLexer(self) # passing the editor to lexer 
        ...
        self.setMarginsFont(QFont("Arial", 12))
