"""
This file contains the code for the syntax highlighter, 
with theme.json being used to allow a specific color for keywords
"""
...
class EditorLexer(QsciLexerCustom):
    ...
    # function that handles json file & sets all the colors
    def _init_theme(self):
        ...
        for clr in colors:
            name: str = list(clr.keys())[0] # in a list so we can loop over it
...
class PyCustomLexer(EditorLexer):
